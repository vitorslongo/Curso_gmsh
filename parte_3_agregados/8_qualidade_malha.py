...
Mede o erro na interpolação do gradiente dentro do elemento.s
Quanto menor, pior a capacidade de resolver gradientes físicos (temperatura, velocidade, etc).
Valor entre 0 (ruim) e 1 (ótimo). 
...
norma de Frobenius (nornalizada) --> soma do tamanho dos vetores que compoem o sistema de coordenadas locais, deteca esticamento do elemento
"""
